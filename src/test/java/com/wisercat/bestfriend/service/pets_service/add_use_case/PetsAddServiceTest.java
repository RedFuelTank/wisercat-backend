...
//
//    private RegistrationPetDto insert;
...
//        service = new PetsAddServiceImpl(repository, mapper);
//    }
//
//    @Nested
...
//        private final static String PET_OWNER_NAME = "Fluffy";
...
//        @BeforeEach
//        void init() {
//            insert = new RegistrationPetDto(PET_CODE, PET_NAME, PET_TYPE, PET_FUR_COLOR, PET_COUNTRY_OF_ORIGIN);
...
//            assertThat(service.save(insert, username))
//                    .isNotNull();
//        }
//
//        @Test
...
//            PetDto petDto = service.save(insert, username);
//
...
//            assertThatThrownBy(() -> service.save(any(), username))
